...
[![Tabler Icons](https://img.shields.io/badge/Tabler%20Icons-3.38.0-blue)](https://tabler-icons.io/)
...
Currently tracking **Tabler Icons v3.38.0** with **6095** icons, including both **Outline** and **Filled** variants. All icons are `static const`, making them fully tree-shakeable.
...
```yaml
dependencies:
  flutter_pas_tabler_icons: ^3.38.0
```
