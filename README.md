...
Currently tracking **Tabler Icons v3.40.0** with **6203** icons, including both **Outline** and **Filled** variants. All icons are `static const`, making them fully tree-shakeable.
